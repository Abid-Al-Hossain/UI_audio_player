# UI Foundry Audio Player Studio

Standalone visual Audio Player generator built with Next.js, React, and TypeScript.

Standalone Audio Player component studio for building native, preview-honest, React-exportable UI patterns that match the UI Foundry product line.
...
- designers building Audio Player UI quickly
- developers who need editable React starting points
- marketplace buyers who want a self-contained Audio Player generator
...
The editor is focused on controls that are native to Audio Player and useful in real product work:
- source intent, controls, duration/progress preview, volume, mute, playback state, and track metadata
- surface, controls, progress bar, thumb, icon, typography, radius, border, and shadow
- compact, card, playlist, podcast, and hero audio player variants
- media accessibility labels and keyboard-safe controls
- React export for audio player shell

The goal is maximum useful depth without adding unrelated controls that would make the component stop reading as Audio Player.
...
This repo is intended to publish as Abid-Al-Hossain/UI_audio_player.
