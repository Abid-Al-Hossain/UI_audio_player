...
export default function Page() {
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Audio Player Studio" headerActions={headerActions} controls={controls} preview={output} /></AppShell>;
}
