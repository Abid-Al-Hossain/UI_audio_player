...
export default function Page() {
  const [state, setState] = useState<AudioPlayerState>(DEFAULT_AUDIOPLAYER_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Audio Player Studio" controls={controls} preview={output} /></AppShell>;
}
