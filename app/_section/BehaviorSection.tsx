...
export default function BehaviorSection({ state, update }: Props) {
  return <SectionCard title="Behavior" subtitle="Native audio controls and playback defaults."><Select label="Preload" value={state.preload} options={["none", "metadata", "auto"]} onChange={(value) => update("preload", value)} />
